...
<html lang="pt-br">
  ...
  <body>
    <div class="container">
        <h1>Código de Confirmação de Email</h1>
      <p>Olá,</p>
      <p>Utilize esse código abaixo para confirmar seu email:</p>
      <p class="code">{{ $code }}</p>
      <p class="aviso">(Esse código é válido por 15 minutos a partir do momento em que foi solicitado)</p>
      <p>Se não é você que solicitou a confirmação de email, por favor ignore este e-mail.</p>
